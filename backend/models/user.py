...
class User(object):
    ...
    def __init__(self, id, email, username, phone_no, password_hash, creation_date, follower_count, following_count, confirmed, profile_photo, cash, bio):
        self.id = id
        self.email = email
    ...
    def __str__(self) -> str:
        user_dict = {"id" : self.id, "username":self.username, "phone_no":self.phone_no,
                    ...
                    "confirmed":self.confirmed, "bio": self.bio}
    ...
    def create_user(user_row):
        ...
        return User(id = user_row["id"], username=user_row["username"], phone_no=user_row["phone_no"], email = user_row["email"],
                             ...
                             follower_count=user_row["follower_count"], following_count=user_row["following_count"], creation_date=user_row["creation_date"], confirmed=user_row["confirmed"], bio=user_row["bio"])